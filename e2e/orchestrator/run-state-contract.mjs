...
export function assertRunStateIdentity(state, runtimeDir, expectedProfile) {
  ...
  const exact = {
    ...
    NYABASE_E2E_POSTGRES_IP: `172.29.${thirdOctet}.14`,
    NYABASE_E2E_REDIS_IP: `172.29.${thirdOctet}.15`,
    NYABASE_E2E_VM_IP: `172.29.${thirdOctet}.3`,
    NYABASE_E2E_VMAGENT_IP: `172.29.${thirdOctet}.16`,
    NYABASE_E2E_API_IP: `172.29.${thirdOctet}.17`,
    NYABASE_E2E_GATEWAY_IP: `172.29.${thirdOctet}.18`,
    NYABASE_E2E_WORKER_IP: `172.29.${thirdOctet}.19`,
    ...
    NYABASE_E2E_DUPLICATE_FAULT_IP: `172.29.${thirdOctet}.23`,
    ...
    NYABASE_E2E_SPLIT_GATEWAY_EDGE_PORT: String(20443 + slot),
