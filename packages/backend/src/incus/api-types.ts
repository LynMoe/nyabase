...
export interface paths {
    ...
    "/1.0/instances/{name}/bitmaps": {
         ...
         */
        post: operations["instance_bitmaps_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/1.0/instances/{name}/debug/repair": {
         ...
         */
        get: operations["instance_debug_repair_post"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/1.0/instances/{name}/nbd": {
         ...
         * @description Upgrades the request to an NBD connection exposing all of the instance's block devices.
         ...
         */
        get: operations["instance_nbd_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/1.0/instances/{name}/port-forward": {
         ...
         * @description Upgrades the request to a raw TCP connection to the given address and port inside of the instance.
         *
         ...
         */
        post: operations["instance_port_forward_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/1.0/storage-pools/{poolName}/volumes/{type}/{volumeName}/bitmaps": {
         ...
         * @description Gets a specific storage volume bitmaps
         */
        get: operations["storage_pool_volume_type_bitmaps_get"];
        put?: never;
        /**
         * Create a storage volume bitmap
         * @description Creates a new storage volume bitmap.
         */
        post: operations["storage_pool_volumes_type_bitmaps_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/1.0/storage-pools/{poolName}/volumes/{type}/{volumeName}/bitmaps/{bitmapName}": {
         ...
         * @description Gets a specific storage volume bitmap
         */
        get: operations["storage_pool_volume_type_bitmap_get"];
        put?: never;
        post?: never;
        /**
         * Delete a storage volume bitmap
         * @description Deletes a storage volume bitmap.
         */
        delete: operations["storage_pool_volumes_type_bitmap_delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/1.0/storage-pools/{poolName}/volumes/{type}/{volumeName}/bitmaps?recursion=1": {
         ...
         * @description Gets a specific storage volume bitmaps
         */
        get: operations["storage_pool_volume_type_bitmaps_get_recursion1"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/1.0/storage-pools/{poolName}/volumes/{type}/{volumeName}/nbd": {
         ...
         * @description Upgrades the request to an NBD connection of the storage volume's block device.
         */
        get: operations["storage_pool_volume_type_nbd_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/1.0/storage-pools/{poolName}/volumes/{type}/{volumeName}/rebuild": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Wipes the underlying storage volume and re-creates an empty one with the
         *     same configuration. Only allowed for custom volumes without snapshots.
         */
        post: operations["storage_pool_volume_type_rebuild_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        InitProfileProjectPost: {
             ...
             */
            description?: string;
            devices?: components["schemas"]["DevicesMap"];
            /**
        ...
        Instance: {
             ...
             */
            ephemeral?: boolean;
            expanded_config?: components["schemas"]["ConfigMap"];
            expanded_devices?: components["schemas"]["DevicesMap"];
            /**
             * Format: date-time
        ...
        InstanceBackupsPost: {
            ...
            optimized_storage?: boolean;
            /**
             * @description Whether to ignore dependent volumes
             * @example false
             */
            root_only?: boolean;
        ...
        InstanceDebugRepairPost: {
            /**
             * @description The desired repair action.
        ...
        /** @description StorageVolumeBitmap represents a volume bitmap */
        StorageVolumeBitmap: {
            /**
             * @description true if the bitmap is in-use by some operation
             * @example true
             */
            busy?: boolean;
            /**
             * Format: int64
             * @description Number of dirty bytes
             * @example 300
             */
            count?: number;
            /**
             * Format: int64
             * @description Granularity of the dirty bitmap in bytes
             * @example 32768
             */
            granularity?: number;
            /**
             * @description true if this is a persistent bitmap that was improperly stored
             * @example true
             */
            ...
            name?: string;
            /**
             * @description true if the bitmap was stored on disk, is scheduled to be stored on disk, or both
             * @example false
             */
            persistent?: boolean;
            /**
             * @description true if the bitmap is recording new writes from the guest
             * @example false
             */
            recording?: boolean;
        };
        /** @description StorageVolumeBitmapsPost represents the fields available for a new volume bitmap */
        StorageVolumeBitmapsPost: {
            /**
             * @description The bitmap is created in the disabled state
             * @example false
             */
            disabled?: boolean;
            /**
        ...
        StorageVolumeRebuildPost: Record<string, never>;
...
export interface operations {
    ...
    instance_bitmaps_post: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["StorageVolumeBitmapsPost"];
            };
        };
        responses: {
            202: components["responses"]["Operation"];
    ...
    instance_debug_repair_post: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["InstanceDebugRepairPost"];
            };
        };
        responses: {
            200: components["responses"]["EmptySyncResponse"];
    ...
    instance_port_forward_post: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["InstancePortForwardPost"];
            };
        };
        responses: {
    ...
    storage_pool_volume_type_bitmap_get: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        metadata?: components["schemas"]["StorageVolumeBitmap"];
                        /**
                         * @description Status description
                         * @example Success
                         */
    ...
    storage_pool_volume_type_rebuild_post: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["StorageVolumeRebuildPost"];
            };
        };
        responses: {
            202: components["responses"]["Operation"];
